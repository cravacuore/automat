...
var state0 = new State("q0", false, false, ctx);
var state1 = new State("q1", false, false, ctx);
var state2 = new State("q2", false, false, ctx);
var state3 = new State("q3", false, true, ctx);
...
new Transition(state0, state0, ctx).draw();
new Transition(state0, state1, ctx).draw();
new Transition(state3, state1, ctx).draw();
new Transition(state1, state2, ctx).draw();
new Transition(state2, state3, ctx).draw();
new Transition(state2, state2, ctx).draw();
